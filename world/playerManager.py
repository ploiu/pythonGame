...
class PlayerManager:
    ...
    def addPlayerToGame(self, gamepad):
        ...
        # pink powerup
        gamepad.map_button(controllers.SNESButtons.START, lambda: player.use_powerUp(6))
        # gray powerup
        gamepad.map_button(controllers.SNESButtons.SELECT, lambda: player.use_powerUp(7))
